...
export async function POST(req: Request) {
  try {
    ...
    const fields = {
        ...
        "Website CMS Update": "",
        "Website Admin": form.hasWebsiteAdmin,
        ...
        "Update Crash Description" : form.computerCrashDescription,
        ...
        "Select Services": form.technologyFriendlyServices.map((opt:Option) => opt.value),
