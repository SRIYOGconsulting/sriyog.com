...
<section className="max-w-[1180px] mx-auto mb-[45px] px-6 lg:px-0">
  ...
  <div className="flex flex-col lg:flex-row gap-10">
    ...
    <div className="w-full lg:w-1/2 flex flex-col gap-8">
      {[
        ...
        {
          question: "Can you build custom software like CRM or enterprise applications?",
          answer:
            "Yes, we build custom CRM, enterprise applications, and automated workflow tools.",
        },
        {
          question: "What stages of the development lifecycle do you manage?",
          answer:
            "We manage every stage from initial consultation and planning to coding, testing, and deployment.",
        },
        {
          question: "How does your software development service benefit businesses?",
          answer:
  ...
  <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-between items-center mt-8 mb-[80px]">
    {consulting
      .filter((item) => item.link !== "software-development") // Exclude current
