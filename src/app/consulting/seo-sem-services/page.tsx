...
<section className="max-w-[1180px] mx-auto mb-[45px] px-6 lg:px-0">
  ...
  <div className="flex flex-col lg:flex-row gap-10">
    ...
    <div className="w-full lg:w-1/2 flex flex-col gap-8">
      {[
        ...
        {
          question: "How do your SEO services help improve online visibility?",
          answer:
    ...
    <div className="w-full lg:w-1/2 flex flex-col gap-8">
      {[
        ...
        {
          question: "How do you ensure the long-term growth of online presence?",
          answer:
            "We focus on building long-term organic traffic and provide transparent performance reporting for sustainable growth.",
        },
        {
          question: "Do you provide ongoing support and adjustments for campaigns?",
          answer:
  ...
  <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-between items-center mt-8 mb-[80px]">
    {consulting
      .filter((item) => item.link !== "social-media-management") // Exclude current
