...
export default function DataAnalysis() {
  ...
  return (
    <>
      <Ribbon
        name="Video/Content/Email Marketing"
        des=""
      />
...
<section className="max-w-[1180px] mx-auto mb-[45px] px-6 lg:px-0">
  ...
  <p className="text-center text-sm text-gray-800 mb-8">
    Here are some of the Video-Content-Email Marketing frequently asked questions
  </p>
  ...
  <div className="flex flex-col lg:flex-row gap-10">
    ...
    <div className="w-full lg:w-1/2 flex flex-col gap-8">
      {[
        {
          question: "What services are included in your Video/Content/Email Marketing?",
          answer:
        ...
        {
          question: "How do your video marketing services help businesses?",
          answer:
        ...
        {
          question: "What kind of content do you create for content marketing?",
          answer:
    ...
    <div className="w-full lg:w-1/2 flex flex-col gap-8">
      {[
        {
          question: "How do you ensure effective email marketing campaigns?",
          answer:
        ...
        {
          question: "Can these marketing services be used individually or together?",
          answer:
            "Yes, our services can be combined or used independently to provide a cohesive and effective marketing approach.",
        },
        {
          question: "What is the ultimate goal of your marketing services?",
          answer:
  ...
  <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-between items-center mt-8 mb-[80px]">
    {consulting
      .filter((item) => item.link !== "video-content-email") // Exclude current
