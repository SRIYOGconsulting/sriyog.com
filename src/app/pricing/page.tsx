...
const page = () => {
  ...
  return (
    <div className='space-y-16 sm:space-y-24 py-16'>
        ...
        {plans.map((plan) => (
            <div className={`border border-gray-300 relative max-w-sm w-full ${plan.name === "Professional" ? "bg-blue-200 p-0.5 mt-6 sm:mt-0 mb-2 sm:mb-0 rounded-b-xl" : "rounded-xl"}`}>
