...
const Pricing = () => {
  ...
  const MonthlyPlans: PlanType[] = [
    ...
    description:"Perfect for Established business & startups",
    price:350,
    features:["Max 50 pages website" ,"Free SSL" ,"Analytics Dashboard" ,"50 Business eMails" ,"50 Managed RoadBlock","3 Forms" ,"5 GB Dedicated Space" ,"10 Monthly Social Banner","Social media Management","3 Campaigns Yearly","1 Social Contest","Premium Dashboard","API access","Digital Asset Management"]},
    
    {name:"Enterprise",
    description:"Perfect for corporates / brands",
    price:550,
    features:
        ["Max 100 pages website" ,
         "Free SSL" ,
