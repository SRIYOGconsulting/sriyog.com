    ...
    <main style={styles.container}>
      ...
      <Section title="Meeting & Attendance">
        <ul>
          ...
          <li>- Make sure you know basics operations of Google Meet</li>
          <li>- Mute your mic until unless you are requested to speak. </li>
          <li>- Make sure to push your codes in GitHubbefore leaving the session everytime. </li>
        </ul>
      ...
      <Section title="LinkedIn & Professional Profiles">
        <p>
          ...
          role, and organization mentioned as in the Internship opportunity in the LinkedIn Vacancy.
        </p>
      </Section>
...
<Section title="Post Internship Programs">
        <ul>
          <li>
            - Candidates successfully completing the internship program may be eligible for starting any startup program in cooperation of SRIYOG Consulting.
          </li>
          <li>
            - Candidates rated 4 stars can be eligible for having a opportunity to get a franchising opportunity of our company anywhere in the globe as a 49% profit sharing partner.  
          </li>
          <li> - Candidates rated 3 stars can work as a frelancer / agent in future projects.</li>
          <li> - Candidates rated below 2 stars can contribute as a volunteer/ guide for level 3 candidates.</li>
      ...
      Apply For Internship : <a href="/internship" style={styles.link}> Click Here </a>
    </main>
  );
}
