      ...
      <section className="lg:w-full ">
        <div className="">
          <div className="lg:max-w-[1180px] mx-auto my-0 md:max-w-[920px] sm:max-w-[720px]  lg:px-12">
            <div>
              <iframe class="airtable-embed" src="https://airtable.com/embed/appcRLi3R3qIFyPIU/shrp1B6DNo8qsHQ4q?viewControls=on" frameborder="0" onmousewheel="" width="100%" height="3533" style="background: transparent; border: 1px solid #ccc;"></iframe>
            </div>
          </div>
        </div>
      </section>
